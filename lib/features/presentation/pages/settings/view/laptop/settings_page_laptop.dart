...
class SettingsPageLaptop extends StatelessWidget {
  const SettingsPageLaptop({super.key});
                ...
                children: [
                  SettingsSection(
                    ...
                    children: [
                      SwitchListTile(
                        ...
                        secondary: const Icon(Icons.brightness_6, size: 32),
                  ...
                  SettingsSection(
                    ...
                    children: [
                      SwitchListTile(
                        contentPadding: const EdgeInsets.all(16),
                        secondary: const Icon(Icons.bug_report, size: 32),
